...
% arara: clean: { files: [ presentazione.aux, presentazione.log, presentazione.nav, presentazione.out, presentazione.snm, presentazione.toc, presentazione.xmpdata, pdfa.xmpi ] }
...
\author[Niccolò~Maltoni]{\large{Niccolò~Maltoni}\\\medskip\small{0000840825}}
